...
#define ONLINE_STUDY 0
#define OFFLINE_STUDY 1
#define STUDY_HISTORY 2
extern  NSInteger heightHeader;
@implementation mySectionHeadView

@synthesize titleLabel, disclosureButton, delegate, section, cells, aTag, heightForHeadView;
...
//        titleLabelFrame.origin.y -= 3.0;
        ...
        titleLabel.tag = 1;
        titleLabel.frame = CGRectMake(30, 7, 250, 30);
