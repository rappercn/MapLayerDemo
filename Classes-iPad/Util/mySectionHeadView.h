...
@optional
-(void)sectionHeaderView:(mySectionHeadView*)sectionHeaderView sectionClosed:(NSInteger)section;

-(void)sectionHeaderView:(mySectionHeadView*)sectionHeaderView sectionOpened:(NSInteger)section;

-(void)sectionHeaderView:(mySectionHeadView*)sectionHeaderView buttonClicked:(NSInteger)section buttonTag:(NSInteger)tag;
@end